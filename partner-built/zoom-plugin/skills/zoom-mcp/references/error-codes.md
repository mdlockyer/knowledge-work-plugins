...
|------|---------|-------|-----|
| `-32001` | `Access token is required` | Missing Authorization header because the server has no token | Set `ZOOM_MCP_ACCESS_TOKEN`, then restart Claude Code or re-enable the plugin |
