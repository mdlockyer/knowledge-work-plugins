...
- **Internal sources** (if the user provides them): research documents, interview notes, survey results; support tickets, feature requests, bug reports; usage data, funnel metrics, behavioral data; interview recordings, meeting summaries, and discussion notes
