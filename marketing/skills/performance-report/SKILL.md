...
3. **Data source**:
   - If the user shares analytics data (spreadsheet, CSV, dashboard screenshot, or pasted metrics), analyze it directly
   - Otherwise ask: "Please paste or share your performance data. I can work with spreadsheets, CSV data, dashboard screenshots described in text, or just the key numbers."
